...
public class ListKeysListener extends ClientListener {

    private PandaClient pandaClient;

    public ListKeysListener(PandaClient pandaClient){
        this.pandaClient = pandaClient;
        pandaClient.getSimpleSocketClient().setSocketListener("listkeysfeedback", this);
    }
